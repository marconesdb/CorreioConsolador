...
const Navbar: React.FC<NavbarProps> = ({ user, onSearch, onLoginClick, onHomeClick, onProfileClick }) => {
      ...
      {user ? (
        <div className="flex items-center space-x-1 ml-2">
          <button className="p-3 hover:bg-gray-100 rounded-full relative">
            <BellIcon />
            <span className="absolute top-2 right-2 h-4 w-4 bg-red-600 text-white text-[10px] font-bold flex items-center justify-center rounded-full">
              3
            </span>
          </button>
